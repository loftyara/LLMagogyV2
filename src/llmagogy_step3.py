...
learning_rate = 3e-4
grad_clip = 1.0
zero_new_weights = True

# Scheduler: 5 stages of model growth
# Format: (n_layer, n_embd, n_head, block_size, dropout, batch_size, max_iters, train file)
#scheduler = [
#    (2, 32, 1, 128, 0.0, 64, 80000, "train_cum_1.txt"),      # Stage 1
#    (4, 64, 2, 256, 0.05, 64, 115000, "train_cum_2.txt"),     # Stage 2
#    (6, 64, 2, 512, 0.05, 64, 75000, "train_cum_3.txt"),    # Stage 3
#    (9, 96, 3, 1024, 0.05, 32, 75000, "train_cum_4.txt"),    # Stage 4
#    (12, 128, 4, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
#]

scheduler = [
    (2, 64, 2, 128, 0.0, 64, 80000, "train_cum_1.txt"),      # Stage 1
    (4, 96, 3, 256, 0.05, 64, 100000, "train_cum_2.txt"),     # Stage 2
    (6, 128, 4, 512, 0.1, 64, 25000, "train_cum_3.txt"),    # Stage 3
    (8, 160, 5, 1536, 0.1, 8, 95000, "train_cum_4.txt"),    # Stage 4
    (10, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
]

#scheduler = [
#    (2, 64, 2, 128, 0.0, 64, 80000, "train_cum_1.txt"),      # Stage 1
#    (3, 96, 3, 256, 0.05, 64, 175000, "train_cum_2.txt"),     # Stage 2
#    (4, 128, 4, 512, 0.05, 64, 40000, "train_cum_3.txt"),    # Stage 3
#    (6, 192, 6, 1536, 0.1, 8, 110000, "train_cum_4.txt"),    # Stage 4
#    (8, 256, 8, 2048, 0.15, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
#]

#scheduler = [
#    (2, 32, 1, 128, 0.0, 64, 80000, "train_cum_1.txt"),      # Stage 1
#    (4, 64, 2, 256, 0.05, 64, 110000, "train_cum_2.txt"),     # Stage 2
#    (6, 64, 2, 512, 0.05, 64, 35000, "train_cum_3.txt"),    # Stage 3
#    (9, 96, 3, 1024, 0.05, 32, 95000, "train_cum_4.txt"),    # Stage 4
#    (12, 128, 4, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
#]

#scheduler = [
#    (2, 64, 2, 128, 0.0, 64, 80000, "train_cum_1.txt"),      # Stage 1
#    (4, 96, 3, 256, 0.05, 64, 80000, "train_cum_2.txt"),     # Stage 2
#    (6, 128, 4, 512, 0.1, 64, 20000, "train_cum_3.txt"),    # Stage 3
#    (8, 160, 5, 1536, 0.1, 8, 95000, "train_cum_4.txt"),    # Stage 4
#    (10, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
#]
...
#scheduler = [
#    (2, 64, 2, 128, 0.0, 64, 80000, "train_cum_1.txt"),      # Stage 1
#    (3, 96, 3, 256, 0.05, 64, 125000, "train_cum_2.txt"),     # Stage 2
#    (4, 128, 4, 512, 0.05, 64, 20000, "train_cum_3.txt"),    # Stage 3
#    (6, 192, 6, 1536, 0.1, 8, 85000, "train_cum_4.txt"),    # Stage 4
#    (8, 256, 8, 2048, 0.15, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
#]
