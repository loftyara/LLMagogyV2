...
#    (4, 64, 2, 256, 0.05, 64, 40000, "train_cum_5.txt", 400, 1.0),     # Stage 2
#    (6, 64, 2, 512, 0.05, 64, 30000, "train_cum_5.txt", 300, 1.0),    # Stage 3
#    (9, 96, 3, 1024, 0.05, 32, 40000, "train_cum_5.txt", 250, 1.0),    # Stage 4
#    (12, 128, 4, 2048, 0.1, 4, 300000, "train_cum_5.txt", 250, 1.0),    # Stage 5 (final)
#]

#scheduler = [
#    (2, 64, 2, 128, 0.0, 64, 50000, "train_cum_5.txt", 0, 1.0),      # Stage 1
#    (4, 96, 3, 256, 0.05, 64, 45000, "train_cum_5.txt", 400, 1.0),     # Stage 2
#    (6, 128, 4, 512, 0.05, 64, 40000, "train_cum_5.txt", 250, 1.0),    # Stage 3
#    (8, 160, 5, 1536, 0.1, 8, 55000, "train_cum_5.txt", 400, 1.0),    # Stage 4
#    (10, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt", 400, 1.0),    # Stage 5 (final)
#]

scheduler = [
    (2, 64, 2, 128, 0.0, 64, 50000, "train_cum_5.txt", 0, 1.0),      # Stage 1
    (3, 96, 3, 256, 0.05, 64, 40000, "train_cum_5.txt", 300, 1.0),     # Stage 2
    (4, 128, 4, 512, 0.05, 64, 40000, "train_cum_5.txt", 300, 1.0),    # Stage 3
    (6, 192, 6, 1536, 0.1, 8, 50000, "train_cum_5.txt", 250, 1.0),    # Stage 4
    (8, 256, 8, 2048, 0.15, 4, 300000, "train_cum_5.txt", 250, 1.0),    # Stage 5 (final)
]
