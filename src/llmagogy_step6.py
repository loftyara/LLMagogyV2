...
#scheduler = [
#    (2, 32, 1, 128, 0.0, 64, 45000, "train_cum_1.txt"),      # Stage 1
#    (4, 64, 2, 256, 0.05, 64, 40000, "train_cum_2.txt"),     # Stage 2
#    (6, 64, 2, 512, 0.05, 64, 35000, "train_cum_3.txt"),    # Stage 3
#    (9, 96, 3, 1024, 0.05, 32, 45000, "train_cum_4.txt"),    # Stage 4
#    (12, 128, 4, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
#]

scheduler = [
    (2, 64, 2, 128, 0.0, 64, 65000, "train_cum_1.txt"),      # Stage 1
    (4, 96, 3, 256, 0.05, 64, 40000, "train_cum_2.txt"),     # Stage 2
    (6, 128, 4, 512, 0.1, 64, 55000, "train_cum_3.txt"),    # Stage 3
    (8, 160, 5, 1536, 0.1, 8, 60000, "train_cum_4.txt"),    # Stage 4
    (10, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
]

#scheduler = [
#    (2, 64, 2, 128, 0.0, 64, 65000, "train_cum_1.txt"),      # Stage 1
#    (3, 96, 3, 256, 0.05, 64, 45000, "train_cum_2.txt"),     # Stage 2
#    (4, 128, 4, 512, 0.05, 64, 60000, "train_cum_3.txt"),    # Stage 3
#    (6, 192, 6, 1536, 0.1, 8, 65000, "train_cum_4.txt"),    # Stage 4
...
#scheduler = [
#    (2, 64, 2, 128, 0.0, 64, 180000, "train_cum_1.txt"),      # Stage 1
#    (4, 96, 3, 256, 0.05, 64, 175000, "train_cum_2.txt"),     # Stage 2
#    (6, 128, 4, 512, 0.1, 64, 95000, "train_cum_3.txt"),    # Stage 3
#    (8, 160, 5, 1536, 0.1, 8, 300000, "train_cum_4.txt"),    # Stage 4
#    (10, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 5 (final)
#]
