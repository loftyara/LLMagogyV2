...
#scheduler = [
#    (1, 32, 1, 32, 0.0, 64, 35000, "train_cum_5.txt"),      # Stage 1
#    (2, 32, 1, 64, 0.0, 64, 35000, "train_cum_5.txt"),     # Stage 2
#    (3, 64, 2, 128, 0.0, 64, 30000, "train_cum_5.txt"),    # Stage 3
#    (4, 64, 2, 256, 0.0, 64, 50000, "train_cum_5.txt"),    # Stage 4
#    (5, 64, 2, 512, 0.05, 64, 40000, "train_cum_5.txt"),    # Stage 5
#    (6, 96, 3, 512, 0.05, 64, 35000, "train_cum_5.txt"),    # Stage 6
#    (7, 96, 3, 1024, 0.05, 32, 300000, "train_cum_5.txt"),    # Stage 7
#    (8, 96, 3, 1024, 0.05, 32, 300000, "train_cum_5.txt"),    # Stage 8
#    (9, 96, 3, 1536, 0.05, 16, 300000, "train_cum_5.txt"),    # Stage 9
#    (10, 128, 4, 1536, 0.1, 8, 300000, "train_cum_5.txt"),    # Stage 10
#    (11, 128, 4, 2048, 0.1, 8, 300000, "train_cum_5.txt"),    # Stage 11
#    (12, 128, 4, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 12
#]

#scheduler = [
#    (1, 32, 1, 32, 0.0, 64, 35000, "train_cum_5.txt"),      # Stage 1
#    (2, 64, 2, 64, 0.0, 64, 35000, "train_cum_5.txt"),     # Stage 2
#    (3, 96, 3, 128, 0.05, 64, 30000, "train_cum_5.txt"),    # Stage 3
#    (4, 96, 3, 256, 0.05, 64, 30000, "train_cum_5.txt"),    # Stage 4
#    (5, 128, 4, 512, 0.05, 64, 35000, "train_cum_5.txt"),    # Stage 5
#    (6, 128, 4, 1024, 0.05, 32, 300000, "train_cum_5.txt"),    # Stage 6
#    (7, 160, 5, 1536, 0.1, 8, 300000, "train_cum_5.txt"),    # Stage 7
#    (8, 160, 5, 1536, 0.1, 8, 300000, "train_cum_5.txt"),    # Stage 8
#    (9, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 9
#    (10, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 10
#]
...
#    (2, 64, 2, 64, 0.0, 64, 35000, "train_cum_5.txt"),     # Stage 2
#    (3, 96, 3, 128, 0.05, 64, 30000, "train_cum_5.txt"),    # Stage 3
#    (4, 128, 4, 256, 0.05, 64, 30000, "train_cum_5.txt"),    # Stage 4
#    (5, 160, 5, 512, 0.1, 32, 35000, "train_cum_5.txt"),    # Stage 5
#    (6, 192, 6, 1024, 0.1, 16, 300000, "train_cum_5.txt"),    # Stage 6
#    (7, 224, 7, 1536, 0.15, 8, 300000, "train_cum_5.txt"),    # Stage 7
#    (8, 256, 8, 2048, 0.15, 4, 300000, "train_cum_5.txt"),    # Stage 8
#]

scheduler = [
    (1, 32, 1, 32, 0.0, 64, 35000, "train_cum_5.txt"),      # Stage 1
    (2, 32, 1, 64, 0.0, 64, 30000, "train_cum_5.txt"),     # Stage 2
    (3, 64, 2, 128, 0.0, 64, 35000, "train_cum_5.txt"),    # Stage 3
    (4, 64, 2, 256, 0.0, 64, 50000, "train_cum_5.txt"),    # Stage 4
    (5, 64, 2, 512, 0.05, 64, 45000, "train_cum_5.txt"),    # Stage 5
    (6, 96, 3, 512, 0.05, 64, 40000, "train_cum_5.txt"),    # Stage 6
    (7, 96, 3, 1024, 0.05, 32, 25000, "train_cum_5.txt"),    # Stage 7
    (8, 96, 3, 1024, 0.05, 32, 20000, "train_cum_5.txt"),    # Stage 8
    (9, 96, 3, 1536, 0.05, 16, 30000, "train_cum_5.txt"),    # Stage 9
    (10, 128, 4, 1536, 0.1, 8, 50000, "train_cum_5.txt"),    # Stage 10
    (11, 128, 4, 2048, 0.1, 4, 30000, "train_cum_5.txt"),    # Stage 11
    (12, 128, 4, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 12
]
...
#    (1, 32, 1, 32, 0.0, 64, 35000, "train_cum_5.txt"),      # Stage 1
#    (2, 64, 2, 64, 0.0, 64, 35000, "train_cum_5.txt"),     # Stage 2
#    (3, 96, 3, 128, 0.05, 64, 40000, "train_cum_5.txt"),    # Stage 3
#    (4, 96, 3, 256, 0.05, 64, 30000, "train_cum_5.txt"),    # Stage 4
#    (5, 128, 4, 512, 0.05, 64, 35000, "train_cum_5.txt"),    # Stage 5
#    (6, 128, 4, 1024, 0.05, 32, 35000, "train_cum_5.txt"),    # Stage 6
#    (7, 160, 5, 1536, 0.1, 8, 40000, "train_cum_5.txt"),    # Stage 7
#    (8, 160, 5, 1536, 0.1, 8, 35000, "train_cum_5.txt"),    # Stage 8
#    (9, 192, 6, 2048, 0.1, 4, 35000, "train_cum_5.txt"),    # Stage 9
#    (10, 192, 6, 2048, 0.1, 4, 300000, "train_cum_5.txt"),    # Stage 10
#]
...
#    (2, 64, 2, 64, 0.0, 64, 35000, "train_cum_5.txt"),     # Stage 2
#    (3, 96, 3, 128, 0.05, 64, 40000, "train_cum_5.txt"),    # Stage 3
#    (4, 128, 4, 256, 0.05, 64, 40000, "train_cum_5.txt"),    # Stage 4
#    (5, 160, 5, 512, 0.1, 32, 35000, "train_cum_5.txt"),    # Stage 5
#    (6, 192, 6, 1024, 0.1, 16, 45000, "train_cum_5.txt"),    # Stage 6
#    (7, 224, 7, 1536, 0.15, 8, 45000, "train_cum_5.txt"),    # Stage 7
#    (8, 256, 8, 2048, 0.15, 4, 300000, "train_cum_5.txt"),    # Stage 8
#]
...
def main():
    ...
    for stage_idx, config in enumerate(scheduler):
        ...
        for iter_num in range(max_iters):
            ...
            if (stage_idx == 11 and ((iter_num % eval_interval1 == 0 and iter_num < eval12_threshold) or (iter_num % eval_interval2 == 0 and iter_num >= eval12_threshold))) or iter_num == max_iters - 1:
